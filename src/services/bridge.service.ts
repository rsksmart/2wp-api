...
export class BridgeService {
  ...
  public getBridgeTransactionByHash(txHash: string): Promise<Transaction> {
    const network = process.env.NETWORK ?? constants.NETWORK_TESTNET;
    return bridgeTransactionParser.getBridgeTransactionsByTxHash(this.web3, txHash, network);
  }
